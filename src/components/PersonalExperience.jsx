  ...
  return (
    <section className="personal-experiance">
      ...
      <div className="employer-details">
        <h3 className="role">Senior Developer</h3>
        <p className="description">
          During this period of time, I was a part of Exela Technology Pvt Ltd.
          I was working as a MEAN Stack Developer with skills - Angular, NodeJs,
          Express Js, MongoDB, HTML and CSS.
        </p>
        <h4 className="location">Pune / India</h4>
      </div>
      <div className="years">
